...
is up. Run:
    ...
    cd /home/agent4/fast_data/fpga/build/uart
...
`run_md.py`. If unset, use:
    ...
    export TEST_SERV=/home/agent4/test_serv

If `/home/agent4/test_serv/run_md.py` is missing, install `test_serv`
before running hardware tests.

## Test records

All hardware test runs must pass `--ledger
/home/agent4/fast_data/agent4/ledger.txt --module <ex> --log
/home/agent4/fast_data/agent4/log.txt` to `run_md.py`. These files live
...
example:
    ...
    make -C build/<ex> all
    cd /home/agent4/fast_data/fpga/build/<ex>
    python3 -u $TEST_SERV/run_md.py \
      --ledger /home/agent4/fast_data/agent4/ledger.txt \
      --module <ex> \
      --log /home/agent4/fast_data/agent4/log.txt
